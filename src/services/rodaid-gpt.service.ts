...
export function construirSystemPrompt(contexto: ContextoUsuario): string {
  ...
  return [
    ...
    ``,
    `CONOCIMIENTO DE LA PLATAFORMA RODAID (actualizado julio 2026):`,
    ``,
    `=== CIT (Certificado de Identidad Técnica) ===`,
    `- Valor: $18.000 ARS (60% taller aliado / 40% RODAID)`,
    `- Vigencia: 12 meses, renovable en cualquier taller aliado`,
    `- Inspección técnica de 20 puntos por taller certificado`,
    `- Huella SHA-256 anclada en Blockchain Federal Argentina (BFA) ERC-721`,
    `- Amparado por Ley Provincial N° 9556`,
    `- Verificable en rodaid.net/verificar sin cuenta`,
    `- Estados: pendiente (72hs pipeline), activo, vencido, revocado, bloqueado`,
    `- Denuncia de hurto: $4.500 ARS (25% del CIT)`,
    ``,
    `=== MARKETPLACE ===`,
    `- Solo bicicletas con CIT activo pueden publicarse`,
    `- RODAID PAY: escrow via MercadoPago (80% vendedor / 20% RODAID)`,
    `- Sistema de disputas con 3 niveles: automático, auditor técnico, resolución administrativa`,
    `- Red de denuncia comunitaria con cruce MPF Mendoza`,
    ``,
    `=== INTEGRACIONES ===`,
    `- Strava OAuth 2.0: odómetro automático, webhook activo (ID 359648)`,
    `- Garmin: en proceso de aprobación Activity API`,
    `- Mantenimiento predictivo: alerta cada 500 km`,
    `- EDI X-Road: integración con gobierno provincial de Mendoza`,
    `- App Android: disponible en Google Play (prueba interna)`,
    ``,
    `=== SUSCRIPCIONES ALIADOS ===`,
    `- Mensual: $18.000 ARS (1 CIT incluido)`,
    `- Anual: $36.000 ARS (2 CITs incluidos)`,
    ``,
    `=== CONTACTO ===`,
    `- Email: federicodegeaceo@rodaid.net`,
    `- Política de privacidad: rodaid.net/privacidad`,
    `- Sobre RODAID: rodaid.net/sobre`,
    `- Aliados: rodaid.net/aliados`,
    `- Desarrolladores/API B2B: rodaid.net/desarrolladores`,
    ``,
    contexto.tieneDatos
