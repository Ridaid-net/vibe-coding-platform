...
exports.SUBJECTS = exports.T = void 0;
...
function btn(text, href, color = C.orange) {
    return `
...
function infoBox(rows, bg = C.grayBg, borderColor = C.teal) {
...
function alertBox(text, level = 'info') {
    const colors = {
...
exports.T = {
  ...
  `, 'Tu contraseña RODAID fue cambiada'),
    ...
    ${infoBox([
        ...
        ...(opts.fechaVencimiento ? [['Vence el', opts.fechaVencimiento]] : []),
    ], '#F0FDF4', C.green)}
  ...
  `, `Tu CIT venció — renovalo para seguir operando`),
    ...
    ${infoBox([
        ...
        ...(opts.numeroCIT ? [['CIT', opts.numeroCIT]] : []),
        ['Estado', '✅ Confirmado'],
    ], '#F0FDF4', C.green)}
  ...
  `, 'Pago rechazado — verificá tus datos'),
    // ── DENUNCIAS ─────────────────────────────────────────
    denunciaRegistrada: (opts) => layout(`
  ...
  `, `CIT ${opts.numeroCIT} transferido a tu nombre en la BFA`),
    ...
    alertaLoginNuevoDispositivo: (opts) => layout(`
  ...
  `, 'Nuevo inicio de sesión en tu cuenta RODAID'),
    codigoVerificacion2FA: (opts) => layout(`
...
exports.SUBJECTS = {
    ...
    citEmitido: (o) => `✅ CIT emitido: ${o.numeroCIT} — ${o.marca} ${o.modelo}`,
    citRechazado: (o) => `❌ CIT rechazado: ${o.numeroCIT}`,
    citPorVencer: (o) => `${o.diasRestantes <= 1 ? '🔴 CIT vence HOY' : `⚠ CIT vence en ${o.diasRestantes} días`}: ${o.numeroCIT}`,
    citVencido: (o) => `🔴 CIT vencido: ${o.numeroCIT} — Renovalo ahora`,
    tasaConfirmada: (o) => `💳 Pago confirmado: $${o.montoARS.toLocaleString('es-AR')} ARS`,
    pagoRechazado: '❌ Pago rechazado — verificá tus datos de pago',
    denunciaRegistrada: (o) => `🚨 Denuncia N° ${o.numeroDenuncia} — ${o.marca} ${o.modelo}`,
    biciRecuperada: (o) => `🎉 Bicicleta recuperada: ${o.marca} ${o.modelo}`,
    ventaConfirmada: (o) => `💰 Venta confirmada: $${(o.montoARS - o.comisionARS).toLocaleString('es-AR')} ARS acreditados`,
    compraCompletada: (o) => `✅ Compra completada: ${o.marca} ${o.modelo}`,
    nuevaOferta: (o) => `💬 Nueva oferta: $${o.ofertaARS.toLocaleString('es-AR')} ARS`,
    disputaAbierta: '⚠ Disputa abierta — RODAID PAY',
    disputaResuelta: '✅ Disputa resuelta — RODAID PAY',
    nftTransferido: (o) => `⛓ CIT ${o.numeroCIT} transferido on-chain`,
    alertaLoginNuevoDispositivo: '🔐 Nuevo inicio de sesión detectado en tu cuenta',
    codigoVerificacion2FA: (o) => `🔑 Código: ${o.codigo} — RODAID`,
};
function getSubject(template, opts) {
    const s = exports.SUBJECTS[template];
