...
const envSchema = zod_1.z.object({
    ...
    MINSEG_CERT_PEM: zod_1.z.string().optional(), // certificado cliente (PEM) para mTLS
    MINSEG_KEY_PEM: zod_1.z.string().optional(), // clave privada (PEM) para mTLS
    MINSEG_CA_PEM: zod_1.z.string().optional(), // CA de MinSeg para verificar servidor
    MINSEG_SANDBOX: zod_1.z.string().optional(), // 'true' para usar sandbox
